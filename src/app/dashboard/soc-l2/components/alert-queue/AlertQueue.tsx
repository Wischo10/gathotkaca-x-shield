...
import { AlertTriangle, Filter, Search, ShieldAlert, ArrowUpRight, Clock, Plus, ChevronLeft, ChevronRight, MoreVertical } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="flex flex-col h-full">
        <div className="flex border-b border-slate-200 dark:border-slate-800 mb-2 overflow-x-auto px-4 mt-2 shrink-0">
        {tabs.map((tab) => (
          <button
            key={tab.name}
            onClick={() => {
