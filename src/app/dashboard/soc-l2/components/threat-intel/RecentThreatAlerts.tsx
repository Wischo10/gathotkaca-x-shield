    ...
    <>
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-sm mt-2 mb-8">
        <div className="flex justify-between items-center mb-4">
          ...
          <button onClick={() => setIsAlertsModalOpen(true)} className="text-xs font-medium text-brand-blue hover:underline">View All Alerts &rarr;</button>
        </div>
      ...
      <Modal isOpen={isAlertsModalOpen} onClose={() => setIsAlertsModalOpen(false)} title="All Threat Intelligence Alerts">
        <div className="overflow-x-auto">
          {loading ? (
