...
export async function POST(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    // 3. Parse optional metadata from request body (e.g. response action description, isolation target)
    ...
    // 4. Record response_started event
    ...
    console.error("[IncidentAction] Error in respond route:", err);
    return NextResponse.json(
